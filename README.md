...
![設定画面](https://pic.dark.moe/images/2018/05/04/94deacbd725cfd8d44723a83774693db.png "設定画面")
...
| 壁透視    | 可視範囲が0より大きい場合のみ機能します。<br />チェックした場合、経過したマスを中心に可視範囲内の八方向のマス状態が公開されますが、チェックを外すと、上下左右四方向しかマス状態が公開されない上に、壁の向こうのマス状態が公開されなくなりますので、難易度がさらに上がります。      |
...
![设置画面](https://pic.dark.moe/images/2018/05/04/f96100fe9990fcc44f4d36e99a762515.png "设置画面")
...
| 透视墙壁    | 可视范围大于0时才有效。<br />勾选时,会以通过的路格子为中心公开八方向的周围格子的信息,取消勾选时,只会公开四方向的周围格子的信息,并且墙壁后的格子信息不会被公开.不勾选时难度会比透视模式更高。      |
